...
PCOM_VREG_CONSUMERS(ldo20) = {
	...
	REGULATOR_SUPPLY("vddio",	"0-0018"),
	REGULATOR_SUPPLY("vio",		"0-0039"),
};
...
static struct proccomm_regulator_info msm7x30_pcom_vreg_info[] = {
	...
	PCOM_VREG_LDO(ldo10,  7, NULL,  2700000,  2700000, 0, -1, 0, 0, 0, 0),
	...
	PCOM_VREG_LDO(ldo20, 38, NULL,  1800000,  1800000, 0, -1, 1, 1, 1, 0),
