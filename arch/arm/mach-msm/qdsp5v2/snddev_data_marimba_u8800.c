...
#include <mach/qdsp5v2/marimba_profile_u8800.h>
...
static struct adie_codec_action_unit ispeaker_rx_48KHz_osr256_actions[] =
	SPEAKER_MUSIC_MONO_RX_48000_OSR_256;
...
static struct snddev_icodec_data
	snddev_idual_mic_broadside_real_stereo_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_dual_mic_broadside_tx_real_stereo",
	.copp_id = 0,
...
static struct adie_codec_action_unit
	handset_secondary_mic_tx_8KHz_osr256_actions[] =
	HANDSET_SECONDARY_MIC_TX_8000_OSR_256;

static struct adie_codec_action_unit
	handset_secondary_mic_tx_16KHz_osr256_actions[] =
...
static struct adie_codec_action_unit ispeaker_secondary_mic_tx_actions[] =
	SPEAKER_SECONDARY_MIC_48000_OSR_256;
...
static void snddev_hsed_config_modify_setting(int type)
{
	...
	device = &msm_ihs_stereo_rx_device;
