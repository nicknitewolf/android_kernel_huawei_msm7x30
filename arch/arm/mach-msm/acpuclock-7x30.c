...
static struct pll pll2_tbl[] = {
	{  25, 0, 1, 0 }, /* 25 * 19,2MHz =  480 MHz */
	{  31, 1, 4, 0 }, /* 31 * 19,2MHz =  595,2 MHz */
	{  42, 0, 1, 0 }, /* 42 * 19,2MHz =  806,4 MHz */
	{  53, 1, 3, 0 }, /* 53 * 19,2MHz = 1017,6 MHz */
	{ 125, 0, 1, 1 }, /* 125 * 19,2MHz / 2 = 1200 MHz */
	{  73, 0, 1, 0 }, /* 73 * 19,2MHz = 1401,6 MHz */
	{  79, 0, 1, 0 }, /* 79 * 19,2MHz = 1516,8 MHz */
	{  84, 0, 1, 0 }, /* 84 * 19,2MHz = 1612,8 MHz */
	{  89, 0, 1, 0 }, /* 89 * 19,2MHz = 1708,8 MHz */
	{  94, 0, 1, 0 }, /* 94 * 19,2MHz = 1804,8 MHz */
};
...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 595200, PLL_2,    3, 0,  122800000, 925, VDD_RAW(925), &pll2_tbl[1]},
	...
	{ 1, 1017600, PLL_2, 3, 0, UINT_MAX, 1200, VDD_RAW(1200), &pll2_tbl[3]},
